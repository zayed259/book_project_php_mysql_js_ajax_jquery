            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item login">
                        <a class="nav-link border rounded" aria-current="page" href="login.php"><i class="fa-solid fa-user"></i> Login</a>
                    </li>
                    <li class="nav-item adPost">
                        <a class="nav-link btn btn-success text-dark ms-lg-4" role="button" aria-current="page" href="post.php">Post Your Ad</a>
                    </li>
                </ul>
            </div>
        </div>
